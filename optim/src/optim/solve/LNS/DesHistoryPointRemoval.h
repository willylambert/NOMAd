 ...
 */
class HistoryPointRemoval: public ADestroyOperator{

public:
	HistoryPointRemoval(std::string s, double minprobability, double maxprobability, int nb_points);
	virtual ~HistoryPointRemoval();
