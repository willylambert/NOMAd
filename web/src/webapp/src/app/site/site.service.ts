...
export class SiteService extends BaseCrudService{
   ...
   constructor(protected http: HttpClient) { super(http,"site") }
  ...
  */
  list(filters : {typeCode: string, statusCode: string,
                  search: string, startIndex: number, length: number} ) : Observable<Site[]>{
    return super.list(filters) as Observable<Site[]>;
  }
