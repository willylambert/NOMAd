...
export class UTCTimePipe implements PipeTransform {
  ...
  /**
   * Gives the UTC time for the input time stamp.
   * You can use this if you want to convert a number of milliseconds from midnight to an hour formatted in HH:mm
   * @param input
   */
